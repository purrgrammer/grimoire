    ...
    <div className="space-y-2 h-full overflow-hidden flex flex-col">
      <div className="p-4 flex flex-col gap-2">
        ...
        <p className="text-sm text-base-content/70">
          Select a relay to load calendar events from and see them displayed on
          the map. Events with geohash or location data will appear as markers.
        </p>
        ...
        <div className="flex gap-2 flex-wrap items-center">
          ...
          {events && (
            <p className="text-sm text-base-content/70 ms-auto">
              {eventsWithLocation.length} events with location out of{" "}
