              ...
              <div>
                ...
                <div className="mt-4 text-left">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-sm">
                    <li>
                      Ensure your browser supports SharedArrayBuffer (Chrome
                      68+, Firefox 79+, Safari 15.2+)
                    </li>
                    <li>
                      Make sure your server is configured with the required
                      headers:
                    </li>
                    ...
                    <li>
                      If running locally, try accessing via HTTPS or localhost
                    </li>
                  </ul>
                </div>
              </div>
    ...
    <div className="container mx-auto p-6 max-w-6xl">
      <div className="mb-6">
        ...
        <p className="text-base-content/70">
          Import, export, and filter Nostr events using Turso WASM SQLite with
