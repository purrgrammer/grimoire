...
const markdownComponents = {
  ...
  a: ({ ...props }: any) => (
    <a className="link link-primary" target="_blank" {...props} />
  ),
  ...
  code: ({ ...props }: any) => (
    <code className="bg-base-300 rounded px-1" {...props} />
  ),
  pre: ({ ...props }: any) => (
...
const HighlightButton = React.forwardRef<
  HighlightButtonRef,
        ...
        <div className="form-control mb-4">
          ...
          {selectedRelays
            ...
            .map((relay) => (
              <label
                key={relay}
                className="cursor-pointer label justify-start mt-2"
              >
                <input
                  type="checkbox"
                  className="checkbox checkbox-primary mr-3"
  ...
  const handlePublishHighlight = useCallback(
    async (comment: string, relays: string[]) => {
      try {
        ...
        let highlightFactory = HighlightFactory.create(
          selectedText,
          addressPointer,
        );
        ...
        alert(
          "Highlight published successfully! (This is a demo - check console for event)",
        );
      } catch (error) {
...
export default function ArticleHighlighter() {
  ...
  const [addressPointer, setAddressPointer] = useState<AddressPointer | null>(
    null,
  );
            ...
            <div className="form-control">
              ...
              <label className="label">
                <span className="label-text-alt">
                  Enter a nostr naddr address pointing to a NIP-23 long-form
                  article
                </span>
              </label>
            </div>
            ...
            <div>
              ...
              <div className="text-xs">
                ...
                <ul className="list-disc list-inside mt-1">
                  ...
                  <li>
                    The article has been deleted or is no longer accessible
                  </li>
          ...
          <div className="card bg-base-100 shadow-sm">
            <div className="card-body">
              ...
              <ol className="list-decimal list-inside space-y-2">
                ...
                <li>
                  The article will load and display with full markdown rendering
                </li>
                <li>
                  Select any text in the article to show the highlight button
                </li>
              ...
              <div className="alert alert-info mt-4">
                ...
                <span>
                  This is a demo app. Actual signing and publishing would
                  require a connected signer (like a browser extension or NIP-07
                  implementation).
                </span>
              </div>
            </div>
