  ...
  return (
    <div className="container mx-auto my-8 px-4 max-w-6xl">
      ...
      <p className="mb-6 text-base-content/70">
        This example demonstrates loading user profile, mailboxes, and events in
        parallel using{" "}
        <code className="bg-base-200 px-2 py-1 rounded">loadAsyncMap</code> for
        ...
        <div className="space-y-6">
              ...
              {data.profile ? (
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="font-bold">
                        {data.profile.displayName || pubkey}
                      </h3>
                  ...
                  {data.profile.dnsIdentity && (
                    <div>
                      <span className="font-semibold">NIP-05:</span>{" "}
                      {data.profile.dnsIdentity}
                    </div>
                  )}
                  ...
                  {data.profile.lightningAddress && (
                    <div>
                      <span className="font-semibold">Lightning Address:</span>{" "}
                      {data.profile.lightningAddress}
                    </div>
                  )}
                </div>
          ...
          <div className="card bg-base-100">
            <div className="card-body">
              ...
              {data.mailboxes ? (
                <div className="space-y-4">
                  {data.mailboxes.outboxes &&
                    data.mailboxes.outboxes.length > 0 && (
                      <div>
                  ...
                  {data.mailboxes.inboxes &&
                    data.mailboxes.inboxes.length > 0 && (
                      <div>
