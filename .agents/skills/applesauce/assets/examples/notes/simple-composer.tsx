  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <p className="text-base-content/70 text-sm">
        Write a kind 1 note in the textarea. Toggle to preview to see how
        mentions, links, hashtags, and media will render. The note is built with{" "}
        <code className="text-xs bg-base-200 px-1 rounded">NoteFactory</code>{" "}
        which automatically creates the appropriate tags.
      </p>
      ...
      {published && (
        <div className="text-success text-sm">Note published successfully!</div>
      )}
      ...
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-3">
          ...
          <AvatarStack
            urls={(blossomServers ?? DEFAULT_BLOSSOM_SERVERS).map(
              (s) => s.href,
            )}
          />
        </div>
