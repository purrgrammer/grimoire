...
const actions = new ActionRunner(eventStore, signer, (event, relays) =>
...
function TimelineItem({
  ...
  const profile = use$(
    () =>
      eventStore.profile({
        pubkey: nutzapInfo.pubkey,
        relays: mergeRelaySets(getSeenRelays(nutzapInfo)),
      }),
    [nutzapInfo],
  );
  ...
  const picture = getProfilePicture(
    profile,
    `https://robohash.org/${nutzapInfo.pubkey}.png`,
  );
  ...
  return (
    <div className="flex flex-col items-center space-y-4">
      ...
      <div className="text-center">
        <p className="text-sm font-mono break-all bg-base-200 p-2 rounded">
          {value}
        </p>
      </div>
    </div>
    ...
    try {
      ...
      try {
        ...
        const proofs = await wallet.ops
          .mintBolt11(amount, quote.quote)
          .asP2PK({ pubkey: nutzapPubkey })
          .run();
        ...
        await actions.run(NutzapProfile, nutzapInfo.pubkey, tokens, {
          comment,
          couch,
        });
      ...
      <div className="modal-box">
          ...
          <div className="space-y-4">
            ...
            <div className="modal-action">
              ...
              <button
                ...
                disabled={isProcessing || !selectedMint}
              >
          ...
          <div className="space-y-4">
            <div className="text-center">
              ...
              <p className="text-sm opacity-70 mb-4">
                Scan the QR code or copy the invoice to pay {amount} sats
              </p>
            </div>
        ...
        {status === "paid" && (
          <div className="text-center space-y-4">
            ...
            <p className="text-sm opacity-70">
              Your nutzap has been successfully sent to the profile
            </p>
            <div className="modal-action">
              <form method="dialog">
...
export default function ZapProfile() {
  const [selectedNutzapInfo, setSelectedNutzapInfo] =
        ...
        <div className="space-y-4">
          ...
          <div className="mb-4">
            <h2 className="text-xl font-semibold mb-2">
              Recent Nutzap Profiles
            </h2>
            <p className="text-sm opacity-70">
              Click on a profile to view details and zap them
            </p>
          </div>
          ...
          {relay.length === 0 && (
            <div className="text-center py-8">
              <div className="alert alert-warning max-w-md mx-auto">
                <span>
                  Please add at least one relay to query for nutzap profiles.
                </span>
              </div>
            </div>
          )}
          ...
          {timeline && timeline.length === 0 && relay.length > 0 && (
            <div className="text-center py-8">
              <div className="alert alert-info max-w-md mx-auto">
                <span>
                  No nutzap profiles found. Profiles will appear here as they
                  are discovered.
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {timeline.map((nutzapInfo) => (
                <TimelineItem
                  ...
                  onSelect={setSelectedNutzapInfo}
                />
              ))}
            </div>
          )}
