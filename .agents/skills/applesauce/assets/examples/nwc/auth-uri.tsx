        ...
        <div className="card-body">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <span
                className={`badge ${parsedUri.isolated ? "badge-warning" : "badge-neutral"} ml-2`}
              >
          ...
          {parsedUri.icon && (
            <div>
              ...
              <div className="mt-1">
                ...
                />
                <code className="px-2 py-1 rounded text-sm font-mono ml-2">
                  {parsedUri.icon}
                </code>
              </div>
            </div>
              ...
              <div className="mt-1 space-y-1">
                {parsedUri.notifications.map((notification) => (
                  <div key={notification} className="ml-2">
                    ...
                    <span className="text-sm opacity-70 ml-2">
                      - {NOTIFICATION_DESCRIPTIONS[notification]}
                    </span>
                  </div>
                ))}
              </div>
...
function UriBuilder({
  ...
  const onSubmit = (data: FormData) => {
    try {
      ...
      alert(
        `Error generating URI: ${error instanceof Error ? error.message : "Unknown error"}`,
      );
    }
  };
        ...
        <div className="card-body space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                {...register("client", {
                  required: "Client public key is required",
                })}
                type="text"
                placeholder="npub1..."
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {Object.entries(NOTIFICATION_DESCRIPTIONS).map(
                ([notification]) => (
                  <label
                    key={notification}
                    className="flex items-center gap-2 cursor-pointer"
                  >
                    <input
                      type="checkbox"
                      checked={watchedNotifications.includes(
                        notification as NotificationType,
                      )}
                      onChange={() =>
                        toggleNotification(notification as NotificationType)
                      }
                      className="checkbox checkbox-sm"
                    />
...
export default function AuthUriExample() {
  ...
  const handleUriGenerated = (uri: string) => {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Failed to parse generated URI",
      );
    }
  };
    ...
    <div className="container mx-auto my-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="mb-4 opacity-70">
          Parse, create, and validate nostr+walletauth URIs for wallet
          authorization.
        </p>
