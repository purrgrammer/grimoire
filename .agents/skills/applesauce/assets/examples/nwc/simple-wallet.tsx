            ...
            <div className="flex justify-between items-start">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <span
                    className={`badge ${tx.type === "incoming" ? "badge-success" : "badge-warning"}`}
                  >
                    {tx.type}
                  </span>
                  <span
              ...
              <div className="text-right">
                ...
                {tx.fees_paid > 0 && (
                  <div className="text-xs text-gray-500">
                    Fee: {formatMsats(tx.fees_paid)} sats
                  </div>
                )}
              </div>
            </div>
...
function CreateInvoiceModal({
  ...
  const supportsNotifications =
    support?.notifications?.includes("payment_received");
          ...
          <div className="space-y-4">
            ...
            {!supportsNotifications && (
              <div className="alert alert-warning">
                This wallet does not support payment notifications. You won't be
          ...
          <div className="space-y-4">
            {isPaid ? (
              ...
              <div className="text-center">
                <p className="mb-4">
                  Invoice created! Share this QR code or payment request:
                </p>
                  ...
                  <div className="card-body p-4">
                    <div className="space-y-2 text-sm">
                      <div>
                        ...
                        <span className="ml-2">
                          {formatMsats(invoice.amount)} sats
                        </span>
                      </div>
                      {invoice.description && (
                        <div>
                ...
                {supportsNotifications && (
                  <div className="alert mt-2">Waiting for payment...</div>
                )}
              </div>
            )}
...
function PayInvoiceModal({
  ...
  const [paymentResult, setPaymentResult] = useState<
    PayInvoiceMethod["response"]["result"] | null
  >(null);
  ...
  useEffect(() => {
    ...
    try {
      ...
      setParsedInvoice(null);
      setParseError(
        err instanceof Error ? err.message : "Invalid invoice format",
      );
    }
  }, [invoiceString]);
  ...
  const isExpired = parsedInvoice
    ? Date.now() / 1000 > parsedInvoice.expiry
    : false;
          ...
          <div className="space-y-4">
                ...
                <div className="card-body p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    <div>
                      ...
                      <span className="ml-2">
                        {parsedInvoice.amount
                          ? `${formatMsats(parsedInvoice.amount)} sats`
                          : "No amount specified"}
                      </span>
                    </div>
                    ...
                    <div>
                      ...
                      <span className="ml-2">
                        {formatDate(parsedInvoice.timestamp)}
                      </span>
                    </div>
                    <div>
            ...
            <div className="modal-action">
              ...
              <button
                ...
                disabled={
                  loading || !parsedInvoice || parseError !== null || isExpired
                }
              >
                {loading ? (
                  <span className="loading loading-spinner loading-sm"></span>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  {paymentResult.fees_paid && paymentResult.fees_paid > 0 && (
                    <div>
                      ...
                      <span className="ml-2">
                        {formatMsats(paymentResult.fees_paid)} sats
                      </span>
                    </div>
                  )}
                </div>
...
export default function SimpleWalletExample() {
  ...
  const [balance, setBalance] = useState<
    GetBalanceMethod["response"]["result"] | null
  >(null);
  ...
  const canListTransactions =
    support && supportsMethod(support, "list_transactions");
      ...
      <div className="space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-sm opacity-70">
            Connect to your Nostr Wallet Connect enabled wallet
          </p>
        </div>
        ...
        {wallet && support === null && (
          <div className="alert alert-warning">
            <span className="text-sm">
              Wallet offline or not found. Please check your connection string.
            </span>
          </div>
        )}
            ...
            <div className="card-body p-6 text-center">
              ...
              {balanceLoading ? (
                ...
                <div className="text-3xl font-bold">
                  {formatMsats(balance.balance)} sats
                </div>
              ) : (
                <div className="text-lg opacity-70">
                  {supportsMethod(support, "get_balance")
                    ? "Unable to load"
                    : "Not supported"}
                </div>
              )}
        ...
        {wallet && support && !canListTransactions && (
          <div className="alert alert-info">
            <span className="text-sm">
              This wallet does not support transaction history.
            </span>
          </div>
        )}
