    ...
    <div className="space-y-2 h-full overflow-hidden flex flex-col">
      <div className="p-4 flex flex-col gap-2">
        ...
        <p className="text-sm text-base-content/70">
          Select a relay to load relay monitor announcements from and see them
          displayed on the map. Monitors with geohash data will appear as
          markers.
        </p>
        ...
        <div className="flex gap-2 flex-wrap items-center">
          ...
          {events && (
            <p className="text-sm text-base-content/70 ms-auto">
              {monitorsWithLocation.length} monitors with location out of{" "}
              {events.length} total monitors
            </p>
          )}
        </div>
      </div>
