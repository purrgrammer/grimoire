        ...
        <div className="card-body space-y-4">
          ...
          <div className="flex gap-2">
            ...
            <button
              className="btn"
              onClick={handleReset}
              disabled={timelineMessages.length === 0 && !isQuerying}
            >
              Reset
            </button>
            ...
            <div className="flex flex-wrap gap-2">
              {relays.map((relay) => (
                <RelayBadge
                  key={relay}
                  relay={relay}
                  state={relayStates.get(relay) || "PENDING"}
                />
              ))}
            </div>
            <div className="overflow-x-auto">
                    ...
                    return (
                      <>
                        ...
                        <tr key={idx}>
                          ...
                          <td>
                            <div
                              className={`badge badge-sm ${MESSAGE_STYLES[msgType] || "badge-ghost"}`}
                            >
                              {msg.type}
                            </div>
                          </td>
