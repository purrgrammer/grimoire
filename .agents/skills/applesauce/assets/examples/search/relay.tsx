    ...
    try {
      ...
      const events = await lastValueFrom(
        pool
          .relay(relay)
          .request(
            { kinds: [kinds.Metadata], search: query.trim(), limit: 50 },
            { timeout: 10_000 },
          )
  ...
  return (
    <div className="container mx-auto max-w-4xl p-4">
      ...
      <p className="text-sm opacity-70 mb-4">
        Search for users on a NIP-50 capable relay. Results come from profile
        (kind 0) events matching the search term.
      </p>
