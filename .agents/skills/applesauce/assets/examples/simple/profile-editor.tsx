...
function ProfileEditor({ user }: { user: User }) {
  ...
  const defaultValues = useMemo<ProfileFormData>(() => {
    ...
    return {
      ...
      display_name:
        profile.metadata.display_name || profile.metadata.displayName || "",
  ...
  const currentWebsite =
    watchedValues.website || profile?.metadata.website || "";
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="bg-base-100 rounded-lg overflow-hidden">
          ...
          <div className="pt-20 px-6 pb-4">
            {/* Avatar URL input */}
            <div className="mb-4">
              <label className="text-base-content/60 mb-1 block">
                Avatar URL
              </label>
              <Controller
                name="picture"
              ...
              />
              {errors.picture && (
                <span className="text-error">{errors.picture.message}</span>
              )}
            </div>
            ...
            <div className="mb-4">
              ...
              />
              {errors.about && (
                <span className="text-error">{errors.about.message}</span>
              )}
            </div>
            ...
            <div className="space-y-2 mb-4">
              ...
              {currentNip05 && (
                <div className="text-base-content/70">{currentNip05}</div>
              )}
              {currentLud16 && (
                <div className="text-base-content/70">⚡ {currentLud16}</div>
              )}
              {currentLud06 && (
                <div className="text-base-content/70">⚡ {currentLud06}</div>
              )}
            </div>
            ...
            <div className="space-y-3 border-t border-base-300 pt-4">
              ...
              <div>
                ...
                />
                {errors.nip05 && (
                  <span className="text-error">{errors.nip05.message}</span>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.lud16 && (
                  <span className="text-error">{errors.lud16.message}</span>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.lud06 && (
                  <span className="text-error">{errors.lud06.message}</span>
                )}
              </div>
