  ...
  return (
    <div className="bg-base-100 mb-2">
      <div className="p-2">
        <div className="flex items-center gap-3 mb-1">
          ...
          <div className="flex-1">
            <h3 className="font-semibold">
              {profile?.displayName || note.author.npub}
            </h3>
        ...
        <p className="whitespace-pre-wrap overflow-hidden text-ellipsis">
...
export default function ThreadExample() {
  ...
  useEffect(() => {
    ...
    try {
      const pointer = decodeEventPointer(
        neventInput.trim().replace(/^nostr:/, ""),
      );
      if (pointer) {
  ...
  const note = use$(() => {
    ...
    return eventStore
      .event(eventPointer)
      .pipe(castEventStream(Note, eventStore));
  ...
  return (
    <div className="container mx-auto my-8 px-4 max-w-4xl">
      ...
      <p className="mb-4">
        Enter a NIP-19 nevent to view the thread with replies
      </p>
